...
object MinecraftContent : PublishableContent {
    ...
    private const val MOTD = "§bPortal §f— this \"server\" is a phone"
    ...
    override fun baseConfig(context: Context): PortalConfig =
        PortalConfig.tcp().copy(targetAddr = "127.0.0.1:$PORT")
    ...
    private fun serveMinecraft(input: DataInputStream, output: DataOutputStream) {
        ...
        val request = readPacket(input) ?: return // status request (id 0x00)
